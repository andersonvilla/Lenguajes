 ...
 *   Ques:  S -> S ? -> (S | ϵ)
 *
 * @param {string} text La entrada de la expresión regular
 * @return {string|object} Devuelve una cadena que es un mensaje de error si no se ha analizado la expresión,
 *                         de otra manera devuelve un objeto que es el árbol de sintaxis..
 */
...
/**
 * SE CONVIERTE LA EXPR A UN AFND
 *
...
/**
 * SE CONVIERTE EL AFND EN AFD
 *
 * @param {object} nfa @see regexToNfa(), La función asume que el AFND es válido
 * @return {object} 
 */
